#
#  Be sure to run `pod spec lint TapSearchViewV2.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "Customizable replacement of builtin UISearchBar.Customizable replacement of builtin UISearchBar"

  spec.homepage     = "https://github.com/Tap-Payments/TapSearchViewV2"
  ...
  spec.source       = { :git => "https://github.com/Tap-Payments/TapSearchViewV2.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "TapSearchViewV2/TapSearchViewV2/Source/**/*.{h,m,swift}"
